...
setup(name='shoal-agent',
      ...
      scripts=['shoal-agent'],
      data_files=[('shoal-agent-conf', ['conf/shoal_agent.conf','conf/shoal-agent.init','conf/shoal-agent.logrotate','conf/shoal-agent.sysconfig','conf/shoal-agent.service'])
                  ],
